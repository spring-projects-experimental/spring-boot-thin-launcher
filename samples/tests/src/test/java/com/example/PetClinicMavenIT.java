...
public class PetClinicMavenIT {
	...
	@Test
	public void thinJar() {
		File jar = new File("../petclinic/target/petclinic-thin-0.0.1-SNAPSHOT.jar");
	...
	public void runJar() throws Exception {
		ProcessBuilder builder = new ProcessBuilder(Utils.javaCommand(), "-Xmx128m",
				...
				"../petclinic/target/petclinic-thin-0.0.1-SNAPSHOT.jar",
				"--server.port=0");
		builder.redirectErrorStream(true);
		started = builder.start();
		String output = output(started.getInputStream(), "Started PetClinicApplication");

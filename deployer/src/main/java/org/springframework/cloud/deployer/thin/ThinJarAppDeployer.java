...
public class ThinJarAppDeployer extends AbstractThinJarSupport implements AppDeployer {
	...
	public RuntimeEnvironmentInfo environmentInfo() {
		return new RuntimeEnvironmentInfo.Builder().spiClass(RuntimeEnvironmentInfo.class).implementationName("thin")
				.implementationVersion("1.0.30.RELEASE").platformApiVersion("N/A").platformApiVersion("N/A")
				.platformClientVersion("1.0.30.RELEASE").platformHostVersion("N/A").platformType("local")
				.build();
	}
